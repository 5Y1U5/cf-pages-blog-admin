import { clearSessionCookie, json, parseCookies, requireDb, sha256Hex, } from "../../_shared/admin.js";
import { recordAudit } from "../../_shared/audit.js";
export function createLogoutHandlers(config) {
    const onRequestPost = async (ctx) => {
        ...
        if (token) {
            ...
            const actor = await db
                .prepare(`SELECT users.id, users.email, users.client_id
           FROM sessions
