 ...
 */
export declare function toRouteHandlers(handlers: PagesStyleHandlers, resolveEnv: () => BlogAdminEnv): NextRouteHandlers;
/**
 ...
 * ```
 */
export declare function mapEnv(source: Record<string, unknown>, aliases: Partial<Record<keyof BlogAdminEnv, string>>): BlogAdminEnv;
export {};
