 ...
 */
export declare const SERVER_ASSIGNED_FIELDS: PublishRequirement[];
/** 画面側で未入力を判定する項目。サーバーが自動で埋めるものを除いた `requiredFields`。 */
export declare function clientPublishRequirements(config: BlogAdminConfig): PublishRequirement[];
/**
 * 登録済みカテゴリから既定カテゴリを選ぶ。
 *
...
export declare function publicPostUrl(config: BlogAdminConfig, slug: string, postType?: string | null): string;
/** 区分が設定されていればその接頭辞、無ければ publish.publicPathPrefix。 */
export declare function resolvePostTypePrefix(config: BlogAdminConfig, postType?: string | null): string;
/** 保存してよい区分か。区分を使っていないサイトでは常に空文字を返す。 */
export declare function normalizePostType(config: BlogAdminConfig, raw?: string | null): string;
export {};
